...
<body>
    ...
    <div class="container">
        ...
        <form action="./save-add-cate" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-6">
...
</html><?php /**PATH C:\xampp\htdocs\php\asm-php2\app\views/categories/add-form.blade.php ENDPATH**/ ?>